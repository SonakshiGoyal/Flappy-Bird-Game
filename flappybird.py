...
def draw_floor():
	...
	screen.blit(floor_surface,(floor_x_pos + 490,570))

def create_pipe():
	random_pipe_pos = random.choice(pipe_height)
	bottom_pipe = pipe_surface.get_rect(midtop = (285,random_pipe_pos))
	top_pipe = pipe_surface.get_rect(midbottom = (285,random_pipe_pos - 300))
...
def score_display(game_state):
	...
	if game_state == 'game_over':
		...
		high_score_rect = high_score_surface.get_rect(center = (240,220))
...
bird_rect = bird_surface.get_rect(center = (60,350))
